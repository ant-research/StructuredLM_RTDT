        ...
        for epoch in train_iterator:
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                with torch.cuda.amp.autocast(dtype=amp_dtype):
                    ...
                    result = self.model(**inputs, coeff=coeff, temperature=temperature, gpt_loss_coeff=gpt_loss_coeff, cls_id=cls_id, min_label_id=min_label_id)
...
if __name__ == '__main__':
    ...
    cmd.add_argument('--model_type', choices=['r2d2-gen', 'gpt', 'llama', 'r2d2', 'r2d2-gen-fast', 'r2d2-fast'], default='r2d2-gen')
