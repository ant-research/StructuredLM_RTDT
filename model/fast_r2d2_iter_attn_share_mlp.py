...
from model.inside_outside_residual import InsideOutsideShareMLPEncoder
...
class FastR2D2Plus(R2D2Base):
    def __init__(self, config, **kwargs):
        ...
        self.inout_encoders = nn.ModuleList([InsideOutsideShareMLPEncoder(config, self._inside_fn, self._outside_fn) 
    ...
    def _outside_fn(self, parent_ij, child_ikj, parent_scores, child_scores):
