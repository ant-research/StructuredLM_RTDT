...
python -m torch.distributed.launch --nproc_per_node $1 --master_port 7089 experiments/bert_multi_label_trainer.py \
...
--output_dir data/save/slu_schedule_bert_dp_indiceMapFixed --domain schedule \
