...
--max_grad_norm 1 --parser_lr 1e-2 --lr 5e-5 --max_batch_size $((64/$1)) --max_batch_len 1000000 --glue_dir data/glue/CoLA \
--task_type cola --vocab_dir data/bert_12_wiki_103 --config_path data/bert_12_wiki_103 --epoch 20 \
