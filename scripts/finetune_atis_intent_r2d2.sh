...
--max_grad_norm 1 --max_batch_size 8 --max_batch_len 1000000 --parser_lr 1e-2 \
...
--task intent --num_samples 256 --sampler sequential --model_name fastr2d2_dp_tree --seed 4023 --tree_path data/ATIS/atis_trees
