...
python -m torch.distributed.launch --nproc_per_node $1 --master_port 7091 trainer/fast_r2d2_multi_label_trainer.py \
...
--output_dir data/save/slu_schedule_intent_r2d2_dp_tree_4023 --domain schedule \
--log_step 100 --eval_step 100 --task intent --sampler random --num_samples 256 \
--model_name fastr2d2_dp_tree --seed 4023
